...
namespace Structural_analysis.Models.SteelBeams
{
    public class StrengthSteelISection : SteelISection
    {
        ...
        public double kappa(double Q) //SP number 8.26
        {
            ...
            double a = (width3Bottom * thick3Bottom + width2Bottom * thick2Bottom + width1Bottom * thick1Bottom +
                width3Top * thick3Top + width2Top * thick2Top + width1Top * thick1Top) / (wallHeight * wallThick);
